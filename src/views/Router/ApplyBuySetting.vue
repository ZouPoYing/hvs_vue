...
export default {
  ...
  methods: {
    getOrder() {
      var self = this;
      axios.post('http://localhost:9091/hvs/order/getOrder', {
    ...
    addOrder() {
      this.dialogVisible = !this.dialogVisible
      var self = this;
      axios.post('http://localhost:9091/hvs/order/addOrder', {
    ...
    modifyOrder() {
      var self = this
      axios.post('http://localhost:9091/hvs/order/modifyOrder', {
        ordername: self.orderForm.ordername,
        technology: self.orderForm.technology,
        minmoney: self.orderForm.minmoney,
        enddate: self.orderForm.enddate,
