...
export default {
  ...
  methods: {
    checkAuditType1() {
      var self = this;
      axios.post('http://localhost:9091/hvs/audit/checkAuditType1',{
    ...
    getSetFile() {
      var self = this;
      axios.post('http://localhost:9091/hvs/set/getSetFile',{
        userid: this.$store.state.user.userid
      }).then(function(res){
        if (res.data.success) {
    ...
    downloadFile() {
      window.location.href='http://localhost:9091/hvs/set/downloadFile/' + this.file.filename;
    },
    handleRemove() {
    ...
    submitForm() {
      ...
      if (self.auditid === '' || self.auditid === undefined) {
        axios.post('http://localhost:9091/hvs/audit/addAuditType1', {
          audittype: '1',
        ...
        axios.post('http://localhost:9091/hvs/audit/modifyAuditType1', {
