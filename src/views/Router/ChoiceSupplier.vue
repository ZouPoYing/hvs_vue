...
export default {
  ...
  methods: {
    getMyTimeOutOrder() {
      var self = this;
      axios.post('http://localhost:9091/hvs/order/getMyTimeOutOrder', {
    ...
    getOfferByOrderid(orderid) {
      var self = this;
      axios.post('http://localhost:9091/hvs/offer/queryOneOfferByOrderid',{
        orderid: orderid
      }).then(function(res){
    ...
    choice(index,row) {
      ...
      var self = this;
      if (index===0) {
        axios.post('http://localhost:9091/hvs/order/endOrder',{
    ...
    reason() {
      var self = this
      axios.post('http://localhost:9091/hvs/audit/addAudit3',{
        orderid: this.orderid,
        supplierid: this.supplierid,
